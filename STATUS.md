...
Steps 1 to 3 of `docs/WORMHOLE_PROTOTYPE.md`: the highways run inside the wormhole,
...
each way. Not built: step 4, the tunnel visual, so inside is black beyond the road's
